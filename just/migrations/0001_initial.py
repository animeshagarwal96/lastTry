# Generated by Django 3.1.7 on 2021-05-01 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_image', models.BinaryField(blank=True)),
                ('category_size', models.CharField(blank=True, default='no size', max_length=100)),
                ('customer_name', models.CharField(max_length=100)),
                ('customer_email', models.CharField(max_length=200)),
                ('customer_phone', models.CharField(max_length=100)),
                ('alternative_number', models.CharField(max_length=100)),
                ('delivery_address', models.CharField(max_length=500)),
                ('Alternate_address', models.CharField(blank=True, max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size1', models.CharField(blank=True, default='', max_length=100)),
                ('size2', models.CharField(blank=True, default='', max_length=100)),
                ('size3', models.CharField(blank=True, default='', max_length=100)),
                ('size4', models.CharField(blank=True, default='', max_length=100)),
                ('size5', models.CharField(blank=True, default='', max_length=100)),
